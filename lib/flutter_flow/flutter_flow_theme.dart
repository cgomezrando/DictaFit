...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color alternate = const Color(0xFF262637);
  late Color primaryText = const Color(0xFFF5F5F7);
  late Color secondaryText = const Color(0xFF9A9AB0);
  late Color primaryBackground = const Color(0xFF0B0B12);
  late Color secondaryBackground = const Color(0xFF15151F);
  late Color accent1 = const Color(0x4C4B39EF);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0x4DEE8B60);
  late Color accent4 = const Color(0xCCFFFFFF);
  late Color success = const Color(0xFF22C55E);
  late Color warning = const Color(0xFFF97316);
